...
compileShaders = do
    ...
    addShader shaderProgram "tutorial06/shader.vs" VertexShader
    addShader shaderProgram "tutorial06/shader.fs" FragmentShader
...
renderSceneCB vbo gWorldLocation gScale = do
    ...
    uniformMat gWorldLocation $= translateMatrix (Vector3 (sin gScaleVal) 0 0)
